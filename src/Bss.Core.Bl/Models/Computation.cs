...
public class Computation
{
    ...
    public async Task SetFormula(
        string formula,
        Func<Computation, Task<ComputationRequirements>> getRequirementsFunc,
        Func<Computation, Task> ensureFormulaValidFunc)
    {
        Formula = formula;
        (_requiredComputations, _requiredMeasures) = await getRequirementsFunc(this);

        await ensureFormulaValidFunc(this);
    }
